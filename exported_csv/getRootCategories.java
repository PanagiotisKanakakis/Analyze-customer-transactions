...
public static void getRootCategories(String[] args) throws AnalysisException {
    ...
    Dataset<Row> category_tree = spark.read().option("header","true").csv("/media/myrto/Files/Documents/Master/DI UOA/BigData/project/Retailrocket_recom_sys_dataset/category_tree.csv");
